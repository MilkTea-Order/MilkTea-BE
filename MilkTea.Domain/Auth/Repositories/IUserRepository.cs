...
public interface IUserRepository
{
    ...
    Task<RefreshTokenEntity?> GetValidRefreshTokenByTokenAsync(string token, CancellationToken cancellationToken);
    ...
    Task<List<RefreshTokenEntity>> GetActiveRefreshTokensByUserIdAsync(int userId);
}
