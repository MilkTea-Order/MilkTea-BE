...
public class PermissionGroupTypeConfiguration : IEntityTypeConfiguration<PermissionGroupTypeEntity>
{
    public void Configure(EntityTypeBuilder<PermissionGroupTypeEntity> builder)
    {
